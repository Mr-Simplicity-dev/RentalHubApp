        ...
        ListEmptyComponent={
          !loading ? (
            <View style={styles.emptyContainer}>
              <Icon name="car-outline" size={60} color="#cbd5e1" />
              <Text style={styles.emptyTitle}>No Transportation Bookings</Text>
...
const styles = StyleSheet.create({
  ...
  detailText: { marginLeft: 6, color: '#475569', fontSize: 13, flex: 1 },
