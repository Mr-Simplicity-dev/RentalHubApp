    ...
    return (
      <View style={styles.centerContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('FumigationCleaningBookingDetail', { bookingId })}
        >
  ...
  return (
    <View style={styles.screen}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSub}>Pay to confirm your booking</Text>
      </View>
      ...
      <View style={styles.summaryCard}>
        ...
        <View style={styles.summaryRow}>
          ...
          <Text style={styles.summaryValue}>{booking.service_name || 'Service'}</Text>
        </View>
        <View style={styles.summaryRow}>
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#0284c7', padding: 30, alignItems: 'center' },
  ...
  summaryCard: { margin: 16, backgroundColor: '#ffffff', borderRadius: 12, padding: 16 },
  ...
  viewButton: { backgroundColor: '#0284c7', borderRadius: 10, paddingVertical: 12, paddingHorizontal: 30, marginTop: 20 },
