...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#AFC2DF', fontFamily: typography.regular, fontSize: 12, lineHeight: 18, marginTop: 6 },
  sectionLabel: { color: colors.blue, fontFamily: typography.bold, fontSize: 9, letterSpacing: 1.2, marginBottom: 8, marginLeft: 2 },
  ...
  chipText: { color: colors.text, fontFamily: typography.medium, fontSize: 10 },
  chipTextActive: { color: colors.white, fontFamily: typography.semibold },
  numberRow: { flexDirection: 'row', gap: 10 },
  numberField: { flex: 1 },
  coordinateHint: { color: colors.muted, fontFamily: typography.regular, fontSize: 10, lineHeight: 15, marginBottom: 10 },
  ...
  frequencyText: { color: colors.text, fontFamily: typography.medium, fontSize: 12 },
  ...
  reviewText: { color: colors.muted, flex: 1, fontFamily: typography.medium, fontSize: 10, lineHeight: 15, marginLeft: 7 },
});
